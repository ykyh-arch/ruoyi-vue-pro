...
public class ErrorCodeAutoGeneratorImpl implements ErrorCodeAutoGenerator {
    ...
    @Override
    @EventListener(ApplicationReadyEvent.class) // 表名应用初始化完成，可以准备接收请求。参考：https://blog.csdn.net/mahl1990/article/details/122616240,https://blog.csdn.net/qq_25073223/article/details/125609773
